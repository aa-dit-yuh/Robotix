...
APPS_DIR = ROOT_DIR.path('Robotix')
...
LOCAL_APPS = (
    'Robotix.users',  # custom users app
...
ADMINS = (
    ("""Technology Robotix Society""", 'aditya.narayan@robotix.in'),
)
...
DATABASES = {
    ...
    'default': env.db("DATABASE_URL", default="postgres://localhost/Robotix"),
}
